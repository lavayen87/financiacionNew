<?php
  ...
  if(isset($_GET['id']) && $_GET['id'] > 0 )
  {
    ...
    $qry = "SELECT loteo FROM loteos WHERE id_loteo = '$id_loteo'";
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid">
          <h2 class="mt-4"><?php echo "Actualizar precios ".$loteo ?></h2>
          <hr>
          ...
          <div class="alert alert-warning" role="alert" id="div_contenido" style="text-align: center;">
                Este módulo permite actualizar precios del loteo a partir de un porcentaje ingresado.  
                Esta acción afectará a todos los lotes.               
          </div>
          <br>
          <div class="alert alert-primary" role="alert" id="div_contenido" style="text-align: center;">
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <input type="number" class="form-control boxporcentaje">
              </div> 
              <div class="col-md-0">
  ...
  <script>
    $(document).ready(function() {
      ...
      $(document).ready(function() {
        ...
        var porcentaje = parseInt(0), id_loteo = parseInt(0);
        datos = [];

         //confirmar actualizacion de precios
        $('#btnRealizar').on('click', function(){

          if( parseInt($(".boxporcentaje").val()) >= parseInt(0) )
          {
            porcentaje = parseInt($(".boxporcentaje").val());
